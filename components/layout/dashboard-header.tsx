        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={activityRef}>
              ...
              {/* Activity Dropdown */}
              {activityOpen && (
                <div className="absolute right-0 mt-2 w-96 bg-white rounded-xl shadow-lg border border-[#E5E0D8] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                  {/* Header */}
                  <div className="px-4 py-3 border-b border-[#E5E0D8] bg-[#FAFAF9]">
                    <div className="flex items-center justify-between">
                      <h3 className="text-sm font-semibold text-[#1C1B1A]">Recent Activity</h3>
                      <button
                  ...
                  <div className="max-h-[400px] overflow-y-auto">
                    {activityLoading ? (
                      <div className="px-4 py-8 text-center">
                        ...
                        <p className="text-xs text-[#8E8983] mt-2">Loading...</p>
                      </div>
                    ) : filteredActivities.length === 0 ? (
                      <div className="px-4 py-8 text-center">
                        <svg className="w-10 h-10 text-[#E5E0D8] mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                        </svg>
                        <p className="text-sm text-[#8E8983]">No recent activity</p>
                      </div>
                    ) : (
                        ...
                        {filteredActivities.slice(0, 10).map((activity) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm text-[#1C1B1A] line-clamp-1">
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <span className="text-[10px] text-[#8E8983]">
            ...
            {/* Divider */}
            <div className="w-px h-6 bg-[#E5E0D8] mx-1"></div>
